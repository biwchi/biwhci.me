...
export const cards = [
  {
    ...
    skills: ['TypeScript', 'JavaScript', "Nuxt", 'Vue', 'Next.js', 'React', 'TailwindCSS', 'HTML', 'CSS', 'PM2', 'Git', 'GitHub', 'Swagger'],
  },
  {
    ...
    skills: ['TypeScript', 'JavaScript', 'Nest.js', 'React', 'Java', 'Vue', 'Nuxt', 'Node.js', 'TailwindCSS', 'PostgreSQL', 'SCSS', 'DOCKER', 'HTML', 'CSS', 'Git', 'GitLab', 'RESTful APis', "Swagger"],
  }
]
